...
It turns the web community lacks both. It’s not that no one has the expertise, but the means are scattered and the efforts are uncoordinated. Most importantly, nobody in the web community has the power to enforce rules on a large amount of the sites.
