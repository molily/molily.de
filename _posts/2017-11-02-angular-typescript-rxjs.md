...
Like [“epics” in redux-observable](https://redux-observable.js.org/docs/basics/Epics.html), an [ngrx effect](https://github.com/ngrx/platform/blob/master/docs/effects/README.md) maps an observable stream of Redux actions to another stream of actions. Asynchronous side effects are possible by calling injected services. These effects are concise, easy to read and easy to test. Writing them efficiently requires a deep knowledge of RxJS though.
